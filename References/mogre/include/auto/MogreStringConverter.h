...
namespace Mogre
{
	...
	public:
		...
		static Mogre::Real ParseReal( String^ val, Mogre::Real defaultValue );
		static Mogre::Real ParseReal( String^ val );
	
		static Mogre::Radian ParseAngle( String^ val, Mogre::Radian defaultValue );
		static Mogre::Radian ParseAngle( String^ val );
	
		static int ParseInt( String^ val, int defaultValue );
		static int ParseInt( String^ val );
	
		static unsigned int ParseUnsignedInt( String^ val, unsigned int defaultValue );
		static unsigned int ParseUnsignedInt( String^ val );
	
		static long ParseLong( String^ val, long defaultValue );
		static long ParseLong( String^ val );
	
		static unsigned long ParseUnsignedLong( String^ val, unsigned long defaultValue );
		...
		static Mogre::Vector2 ParseVector2( String^ val, Mogre::Vector2 defaultValue );
		static Mogre::Vector2 ParseVector2( String^ val );
	
		static Mogre::Vector3 ParseVector3( String^ val, Mogre::Vector3 defaultValue );
		static Mogre::Vector3 ParseVector3( String^ val );
	
		static Mogre::Vector4 ParseVector4( String^ val, Mogre::Vector4 defaultValue );
		static Mogre::Vector4 ParseVector4( String^ val );
	
		static Mogre::Matrix3^ ParseMatrix3( String^ val, Mogre::Matrix3^ defaultValue );
		static Mogre::Matrix3^ ParseMatrix3( String^ val );
	
		static Mogre::Matrix4^ ParseMatrix4( String^ val, Mogre::Matrix4^ defaultValue );
		static Mogre::Matrix4^ ParseMatrix4( String^ val );
	
		static Mogre::Quaternion ParseQuaternion( String^ val, Mogre::Quaternion defaultValue );
		static Mogre::Quaternion ParseQuaternion( String^ val );
	
		static Mogre::ColourValue ParseColourValue( String^ val, Mogre::ColourValue defaultValue );
